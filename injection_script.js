...
ensureDomLoaded(()=>{
	...
	domainBypass(/^((www\.)?(up-load\.io|cosmobox\.org))$/,()=>insertInfoBox("{{msg.infoFileHoster}}"))
	...
	domainBypass(/terbit21\.(club|online|host|show|top)/,()=>ifElement("a#downloadbutton[href]",a=>countIt(safelyAssign(a.href))))
