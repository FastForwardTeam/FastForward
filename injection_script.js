...
ensureDomLoaded(()=>{
	...
	domainBypass(/tr\.link|movienear\.me|lewat\.club|droidtamvan\.me|(liveshootv|modebaca)\.com|shrink\.world|link\.mymastah\.xyz|(sportif|cararoot)\.id/,()=>{
	...
	let dT=setInterval(()=>{
		...
		if(typeof app_vars=="object")
		{
			...
			domainBypass(/movienear\.me|lewat\.club|droidtamvan\.me|(liveshootv|modebaca)\.com|shrink\.world|link\.mymastah\.xyz|(sportif|cararoot)\.id|healthinsider\.online/,()=>{
