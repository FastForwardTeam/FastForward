...
unsafelyNavigate=target=>{
	...
	switch(target)//All values here have been tested using "Take me to destinations after 0 seconds."
	{
		...
		case "https://api.thinksuggest.org/?m=c&t=j&h=Jump&q=_clickout&pid=linkvertisenet&k=https%3A%2F%2Ffluxteam.xyz%2Fks%2Fmainkeysys.php&subid=klickouts":
		url+="&safe_in=170"
		break;
	}
	location.assign(url)
...
ensureDomLoaded(()=>{
	...
	domainBypass(/^((www\.)?(((get-click2|informations-library|media-blue|akashirohige|aibouanimelink)\.blogspot|business\.ominfoupdate|majidzhacker|citgratis|tekloggers|pro\-bangla)\.com|pastikan\.me|(blog\.infolanjutan|jkoding)\.xyz|safe\.onbatch\.my\.id))$/,()=>{
