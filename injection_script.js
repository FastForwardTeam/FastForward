...
ensureDomLoaded(()=>{
	...
	domainBypass(/((get-click2|informations-library|media-blue|akashirohige)\.blogspot|business\.ominfoupdate|tinyurl\.majidzhacker)\.com|pastikan\.me|blog\.infolanjutan\.xyz/,()=>{
