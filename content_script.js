...
if(document instanceof HTMLDocument)
{
	...
	brws.runtime.sendMessage({type: "can-run"}, res => {
		...
		script.innerHTML=`(()=>{
			...
			hrefBypass(/1link\\.club|cshort\\.(org|xyz)|muhammadyoga\\.me|u\\.to|skiplink\\.io|healthykk\\.com|punchsubs\\.net|linkasm\\.com|firefaucet\\.win\\/l\\/|emulator\\.games\\/download\\.php|2speed\\.net\\/file\\//,()=>{
				window.setInterval=f=>setInterval(f,1)
			})
